...
public class ContainerOversizeTest {
    ...
    public void setUp(){
        ...
        fullOversizeContainer.addBox(oversizeBox);
        fullOversizeContainer.addBox(oversizeBox);
        assertTrue(oversizeBox.isOversized());
        assertEquals("Container Capacity: " + fullOversizeContainer.getCapacity()
        + " | Current Size" + fullOversizeContainer.getCurrentSize()
        + " | Is Empty? " + fullOversizeContainer.isEmpty()
        + " | Is Full? " + fullOversizeContainer.isFull()
        , 1, 1);
    }
    ...
    public void testconstructContainerForBoxWithOversizedBoxOnOversizeContainer(){
        Box box = oversizeBox;
        Container container = oversizeContainer.constructContainerForBox(box);
        assertTrue("Wrong expected Type. Expected Oversize, was given " + container.getType().toString() + 
        " Box Length: " + box.getWidth() + " Box Height: " + box.getHeight(), 
        container.getType() == ArchDesign.entities.Container.Type.Crate);
    ...
    public void testEmptyContainerThrowsException() {
        assertEquals(-1, oversizeContainer.getCapacity());
